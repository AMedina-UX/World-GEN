            ...
            <div className="flex items-center gap-3">
              ...
              {videoSources && (
                <div className="flex items-center gap-2">
                  <span className="text-[11px] text-white/80 bg-white/10 border border-white/10 px-2.5 py-1 rounded-lg font-medium select-none font-mono">
                    {selectedQuality === 'auto' ? `${detectedQuality} (automático)` : selectedQuality}
                  </span>
